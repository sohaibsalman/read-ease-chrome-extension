...
function addCloseButton() {
  ...
  closeButton.title = 'Close Read Ease';
...
function handleSummarizeClick(modelToTryWith) {
  ...
  if (typeof userOptions === 'undefined') {
    ...
    return window.alert(
      "To use the summarizer, add your OpenAI API key to Read Ease's options page. For more info, see https://justread.link/summarizer"
    );
  }
  ...
  try {
    ...
    return console.error(
      'Summarizer options are invalid. See https://justread.link/summarizer for more info.'
    );
  }
...
function addHighlighterNotification() {
  const notification = {
    textContent:
      "To annotate this article, upgrade to <a href='https://justread.link/#get-Just-Read' target='_blank'>Read Ease Premium</a>! Annotations are just <em>one</em> of the additional features included.",
...
function addInlineCommentFunctionality() {
  ...
  simpleArticleIframe.addEventListener('click', (e) => {
    ...
    if (!isPremium) {
      alert(
        'Sorry, this feature is only available to Read Ease Premium users! Sign up at justread.link'
      );
      return;
    }
...
function getContentFromJrView(keepJR) {
  // Create a copy of the Read Ease content
...
function getSavableLink() {
  if (isPremium && jrSecret) {
    ...
    const notification = {
      textContent:
        "To share this reader view with others, upgrade to <a href='https://justread.link/#get-Just-Read' target='_blank'>Read Ease Premium</a>! Shared pages are just <em>one</em> of the additional features included.",
      url: 'https://justread.link/#get-Just-Read',
      primaryText: 'Learn more',
      secondaryText: 'Maybe later',
    };
...
function createSimplifiedOverlay() {
  ...
  //     const notification = {
  //       textContent:
  //         "To add comments, upgrade to <a href='https://justread.link/#get-Just-Read' target='_blank'>Read Ease Premium</a>! Comments are just <em>one</em> of the additional features included.",
  //       url: 'https://justread.link/#get-Just-Read',
  //       primaryText: 'Learn more',
  //       secondaryText: 'Maybe later',
  //     };
...
function continueLoading() {
  ...
  // Get how many times the user has opened Read Ease
